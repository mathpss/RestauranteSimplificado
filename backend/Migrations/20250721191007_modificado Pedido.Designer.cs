...
namespace backend.Migrations
{
    ...
    [Migration("20250721191007_modificado Pedido")]
    partial class modificadoPedido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Pedido", b =>
                {
                    b.HasOne("backend.Models.PedidoEntrega", "PedidoEntrega")
                        .WithMany("Pedidos")
                        .HasForeignKey("PedidoEntregaId");

                    b.HasOne("backend.Models.PedidoRetirada", "PedidoRetirada")
                        .WithMany("Pedidos")
                        .HasForeignKey("PedidoRetiradaId");

                    b.Navigation("PedidoEntrega");

                    b.Navigation("PedidoRetirada");
                });
